...
app.add_typer(quickstart_app, name="quickstart", help="Complete setup guide for new users")

# Add workspace management
from .commands.workspace import workspace_app
app.add_typer(workspace_app, name="workspace", help="Manage workspace and configuration")

# Add interactive mode
from .commands.interactive import interactive_app
app.add_typer(interactive_app, name="interactive", help="Interactive campaign builder with live preview")

# Add template management - update to use content_templates
from .commands.content_templates import templates_app
app.add_typer(templates_app, name="templates", help="📋 Content templates for promotional activities")

# Add AI management
from .commands.ai import ai_app
app.add_typer(ai_app, name="ai", help="AI provider configuration and testing")

# Add CI/CD integration
from .commands.cicd import cicd_app
app.add_typer(cicd_app, name="cicd", help="CI/CD integration and automation")

# Add language support
from .commands.lang import lang_app
app.add_typer(lang_app, name="lang", help="Language and localization settings")

# Add Advanced AI integration
# Note: Advanced AI integration commands removed for OSS release

# Add analytics and insights
from .commands.insights import insights_app
app.add_typer(insights_app, name="insights", help="Advanced analytics and insights dashboard")

# Add promotion strategies (currently disabled due to click/typer compatibility)
# from .commands.promotion import promotion
# app.add_typer(promotion, name="promotion", help="Advanced promotion strategies and automation")

# Add daemon commands
from .commands.daemon import daemon_app
app.add_typer(daemon_app, name="daemon", help="Daemon mode with web interface and monitoring")

# Register plan, apply, and destroy as direct commands
...
app.add_typer(state_app, name="state", help="Manage campaign state")
app.add_typer(auth_app, name="auth", help="Manage authentication")
app.add_typer(setup_app, name="setup", help="Setup wizard and configuration tools")
app.add_typer(content_app, name="content", help="Content generation and strategy")

# Add autopilot mode
from .commands.autopilot import autopilot_app
app.add_typer(autopilot_app, name="autopilot", help="🤖 AI-driven fully automated social media management")

# Add competitive intelligence
from .commands.intelligence import intelligence_app
app.add_typer(intelligence_app, name="intelligence", help="🕵️ Competitive intelligence and market analysis")

# Add viral prediction and optimization
from .commands.viral import viral_app
app.add_typer(viral_app, name="viral", help="🦠 Viral prediction and content optimization")

# Add stop/resume functionality 
from .commands.stop import stop_app
app.add_typer(stop_app, name="stop", help="⏸️  Stop and resume promotional activities")

# Add enhanced Reddit functionality
# TODO: Convert from Click to Typer
# from .commands.reddit_enhanced import reddit_enhanced
# app.add_typer(reddit_enhanced, name="reddit", help="🔴 Enhanced Reddit automation and community engagement")

# Add blog content generation
# TODO: Convert from Click to Typer
# from .commands.blog_generator import blog_generator
# app.add_typer(blog_generator, name="blog", help="📝 Generate blog content for technical marketing")

# Add Hacker News posting
# TODO: Convert from Click to Typer
# from .commands.hackernews import hackernews
# app.add_typer(hackernews, name="hackernews", help="🟠 Hacker News posting automation and optimization")

# Add preview and notification system
# TODO: Convert from Click to Typer
# from .commands.preview import preview
# app.add_typer(preview, name="preview", help="👁️ Content preview and notification management")

# Add campaign management system
# TODO: Convert from Click to Typer
# from .commands.campaign import campaign
# app.add_typer(campaign, name="campaign", help="🎯 Seasonal campaigns and event marketing")

# Add profile generation system
# TODO: Convert from Click to Typer
# from .commands.profile import profile
# app.add_typer(profile, name="profile", help="👤 Generate social media profiles and bios")
    ...
    async def run_quick_post():
        try:
            ...
            session = await content_reviewer.create_review_session(
                ...
                auto_approve=skip_review or yes
            )
            
            # Conduct review if not skipped
            if not skip_review and not yes:
